...
$taskName = "Etam Localization Weekly Update"
...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Description "Updates the Etam localization HTML review tool and CSV queues every Monday morning." -Force | Out-Null
